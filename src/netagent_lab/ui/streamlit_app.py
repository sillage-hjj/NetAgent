...
from netagent_lab.ui.components import render_json_expander, render_table
from netagent_lab.ui.renderers import diff_summary_rows, summarize_tool_result
...
def main() -> None:
    ...
    args = _parse_args()
    st.set_page_config(page_title="NetAgent Lab", layout="wide")
    st.title("NetAgent Lab Developer UI")
