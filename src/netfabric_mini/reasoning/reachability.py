...
from netfabric_mini.sim.pathing import check_service_reachability as _check_service
from netfabric_mini.sim.pathing import compute_probe_result as _compute_probe
