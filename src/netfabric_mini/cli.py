...
from netfabric_mini.db import connect_db, init_db as init_sqlite_db
from netfabric_mini.investigator import investigate_ticket
from netfabric_mini.log_parser import parse_and_store_all
from netfabric_mini.report import render_markdown_report, render_text_report
from netfabric_mini.seed_loader import list_cases as list_available_cases
from netfabric_mini.seed_loader import load_case
from netfabric_mini.cli_sim import sim_app
from netfabric_mini.cli_agent import agent_app

app = typer.Typer(
    name="nfmini",
    help="Offline, read-only network incident investigation demos.",
