...
class OpenAIResponsesClient:
    ...
    def client(self) -> Any:
        ...
        try:
            ...
            raise RuntimeError("OpenAI provider requires installing netfabric-mini[llm] or the official openai package.") from exc
        self._client = OpenAI()
        return self._client
    ...
    def create_response(
        ...
        *,
        ...
        kwargs: dict[str, Any] = {
            "input": [_message_to_input(message) for message in messages],
